...
- Copy the contents of [ai-plugin.json](../../examples/authentication-methods/service-http/ai-plugin.json) into the main [ai-plugin.json](../../.well-known/ai-plugin.json) file.
