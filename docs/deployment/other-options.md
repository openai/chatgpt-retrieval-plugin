...
After you create your app, make sure to change the plugin url in your plugin manifest file [here](/.well_known/ai_plugin.json), and in your OpenAPI schema [here](/.well_known/openapi.yaml), and redeploy.
